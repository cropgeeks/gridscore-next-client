...
import { getColumnLabel } from '@/plugins/misc'
...
export default {
  ...
  methods: {
    ...
    updateColumnHeader: function (col) {
      ...
      this.ctx.fillText(this.$n(getColumnLabel(this.trial.layout, col)), x + this.dimensions.cellWidth / 2, y + this.dimensions.padding + this.dimensions.fontSize / 2)
    },
    reset: function () {
