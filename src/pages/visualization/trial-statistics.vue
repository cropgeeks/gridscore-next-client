<template>
  <v-container>
    ...
    <template v-if="trial && trialStats">
      <v-row :dense="mdAndDown">
        <v-col>
          <v-list-item class="pa-4" variant="tonal" color="primary" active min-width="min(100vw, 300px)" :prepend-icon="mdiLandFields" :title="$t('widgetTrialDataStatsPlots')"><template #append><v-badge inline :content="getNumberWithSuffix(trialStats.plots, 1)" /></template></v-list-item>
        </v-col>
        <v-col>
          <v-list-item class="pa-4" variant="tonal" color="primary" active min-width="min(100vw, 300px)" :prepend-icon="mdiTagMultiple" :title="$t('widgetTrialDataStatsTraits')"><template #append><v-badge inline :content="getNumberWithSuffix(trialStats.traits, 1)" /></template></v-list-item>
        </v-col>
        <v-col>
          <v-list-item class="pa-4" variant="tonal" color="primary" active min-width="min(100vw, 300px)" :prepend-icon="mdiCommentMultiple" :title="$t('widgetTrialDataStatsComments')"><template #append><v-badge inline :content="getNumberWithSuffix(trialStats.comments, 1)" /></template></v-list-item>
        </v-col>
        <v-col>
          <v-list-item class="pa-4" variant="tonal" color="primary" active min-width="min(100vw, 300px)" :prepend-icon="mdiFlag" :title="$t('widgetTrialDataStatsEvents')"><template #append><v-badge inline :content="getNumberWithSuffix(trialStats.events, 1)" /></template></v-list-item>
        </v-col>
        <v-col>
          <v-list-item class="pa-4" variant="tonal" color="primary" active min-width="min(100vw, 300px)" :prepend-icon="mdiPencilRuler" :title="$t('widgetTrialDataStatsMeasurements')"><template #append><v-badge inline :content="getNumberWithSuffix(trialStats.measurements, 1)" /></template></v-list-item>
        </v-col>
        <v-col>
          <v-list-item class="pa-4" variant="tonal" color="primary" active min-width="min(100vw, 300px)" :prepend-icon="mdiTextureBox" :title="$t('widgetTrialDataStatsArea')"><template #append><v-badge inline :content="getNumberWithSuffix(trialStats.area, 1)" /></template></v-list-item>
        </v-col>
        <v-col>
          <v-list-item class="pa-4" variant="tonal" color="primary" active min-width="min(100vw, 300px)" :prepend-icon="mdiCalendarCollapseHorizontal" :title="$t('widgetTrialDataStatsDayRange')"><template #append><v-badge inline :content="getNumberWithSuffix(trialStats.dayRange, 1)" /></template></v-list-item>
        </v-col>
        <v-col>
          <v-list-item class="pa-4" variant="tonal" color="primary" active min-width="min(100vw, 300px)" :prepend-icon="mdiCalendarMultiselect" :title="$t('widgetTrialDataStatsActiveDays')"><template #append><v-badge inline :content="getNumberWithSuffix(trialStats.activeDays, 1)" /></template></v-list-item>
        </v-col>
      </v-row>
      {{ trialStats }}
...
<script setup lang="ts">
  ...
  import { mdiCalendarCollapseHorizontal, mdiCalendarMultiselect, mdiCommentMultiple, mdiFlag, mdiLandFields, mdiPencilRuler, mdiTagMultiple, mdiTextureBox } from '@mdi/js'
